  ...
  return (
    <div>
        ...
        <div className='flex-container'>
            ...
            <img src='../images/landing-photo.png' alt="Boy playing video games"></img>
        </div>

        <div className='text-center'>
            <button className="start-button">Get Started
            </button>
        </div>
        ...
        <div className='game-display'>
            <h1 className='text-center' id="regFont">Learn the logic of code by playing classic games!</h1>

            <div className='gameboxes'>
                <div id='box1'>
                    <img src='../images/pencil.png' alt="pencil" className='size-20'></img>
                    <p>Word Scramble</p>
                </div>
                ...
                <div id='box3'>
                    <img src='../images/scissors.png' alt="scissors" className='size-20'></img>
