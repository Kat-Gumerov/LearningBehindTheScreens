    ...
    <div>
      ...
      <div className='flex h-screen'>
        ...
        <div className='w-1/2 flex flex-col justify-start items-start h-screen px-32 py-72'>
          ...
          <p className='improve'>
            Let us know how we can improve our site, questions, etc!
          </p>

          <p className='gmail'>
            <a href='mailto:codecade@gmail.com'>codecade@gmail.com</a>
          </p>
        </div>
        ...
        <div className='w-1/2 flex flex-col justify-start items-end h-screen px-48 py-48'>
          ...
          <form className='contactForm' onSubmit={handleOnSubmit}>
            <div className='max-w-4xl mx-auto p-4 border-2 border-blue-500 rounded-xl shadow-lg bg-sky-200 space-y-6'>
              ...
              <button
                type='submit'
                className='w-1/3 mx-auto bg-[#fdc066] text-[#073B4C] font-bold py-3 rounded-lg hover:bg-orange-700 transition block text-center border-0 border-b-2 border-gray-300 rounded-lg appearance-none dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600'
              >
                Submit
              </button>
            </div>
