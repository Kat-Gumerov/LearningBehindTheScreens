...
const GameView = ({ onUserClick, buttonDisabled }: GameViewProps) => {
  ...
  return (
    <div className='gameview text-center'>
      ...
      <h1 className='text-s text-blue-700 mb-14px'>Try to unscramble the word below and type your guess in the box!</h1>
      ...
      <button
        ...
        className='bg-blue-500 text-white ml-2 px-4 py-2 bg-slate-50 rounded'
      >
        Guess
      </button>
